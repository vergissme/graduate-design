...
public class ImageToCircleUtil {
    ...
    public static BufferedImage cutHeadImages(String headUrl,String outputPath) {
        ...
        try {
            ...
            System.out.println("cutHeadImages======>" + e.getMessage());
        }
        return null;
    }
    ...
    public static BufferedImage scaleByPercentage(BufferedImage inputImage, int newWidth, int newHeight) {
        ...
        try {
            ...
            System.out.println("scaleByPercentage======>" + e.getMessage());
        }
        return null;
    }
}
